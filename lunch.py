...
def init_db():
    ...
    ''')
    # ✅ Tambah kolom claim_time jika belum ada
    try:
        c.execute("ALTER TABLE claims ADD COLUMN claim_time TEXT")
    except:
        pass
...
.ut-header img {{ height:64px; border-radius:8px; }}
.ut-header h1 {{ font-size:26px; color: {TEXT}; margin:0; letter-spacing:0.2px; }}
.ut-sub {{ color: #6B7280; margin-top:4px; font-size:13px; text-align:center }}
.card {{
    background: {CARD};
    color: {TEXT};
    padding: 18px;
...
.card-small {{ padding:12px; border-radius:10px; box-shadow: 0 6px 18px rgba(15,23,42,0.04); }}
.stButton button {{
...
<div class="ut-header">
    ...
    <div style='text-align:left'>
        ...
        <div class='ut-sub'>Sistem klaim makan siang karyawan — United Tractors</div>
    </div>
</div>
""", unsafe_allow_html=True)
...
with tab2:
    ...
    if admin_pass == "admin123":
        ...
        <div style="display:flex;gap:18px;flex-wrap:wrap;margin-top:10px;">
            <div class="card card-small" style="flex:1;min-width:200px;">
...
# =========================
with tab3:
    st.header("Bantuan & Kontak")
    st.markdown("""
    <div style="background-color:#FFFFFF;border-radius:10px;padding:16px;margin-bottom:12px;box-shadow:0 6px 18px rgba(15,23,42,0.04);">
        <h4 style="margin:0;color:#111827;">Helmalya RP</h4>
        <p style="margin:6px 0;color:#6B7280;"> <a href="mailto:HelmalyaRP@unitedtractors.com">HelmalyaRP@unitedtractors.com</a><br>
         0858 5982 3983</p>
    ...
    <p style="color:#6B7280;">Jam kerja: 08.00 - 16.30 WIB</p>
    """, unsafe_allow_html=True)
